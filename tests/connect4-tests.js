/**
 * Test suite for Connect4 game
 */
function runConnect4Tests(testSuite) {
    // Test game initialization
    testSuite.test('Connect4', 'Game initialization', () => {
    ...
    testSuite.test('Connect4', 'Board initialization', () => {
        const game = new Connect4Game();
    ...
    // Test valid move
    testSuite.test('Connect4', 'Valid move', () => {
        const game = new Connect4Game();
    ...
    // Test invalid moves
    testSuite.test('Connect4', 'Invalid move - out of bounds', () => {
        const game = new Connect4Game();
    ...
    // Test column full
    testSuite.test('Connect4', 'Invalid move - column full', () => {
        const game = new Connect4Game();
    ...
    // Test horizontal win
    testSuite.test('Connect4', 'Horizontal win detection', () => {
        const game = new Connect4Game();
    ...
    // Test vertical win
    testSuite.test('Connect4', 'Vertical win detection', () => {
        const game = new Connect4Game();
    ...
    // Test diagonal win
    testSuite.test('Connect4', 'Diagonal win detection', () => {
        const game = new Connect4Game();
    ...
    // Test undo move
    testSuite.test('Connect4', 'Undo move', () => {
        const game = new Connect4Game();
    ...
    // Test game reset
    testSuite.test('Connect4', 'Game reset', () => {
        const game = new Connect4Game();
    ...
    testSuite.test('Connect4', 'AI initialization', () => {
    ...
    testSuite.test('Connect4', 'AI move generation', () => {
        const game = new Connect4Game();
    ...
    // Test helper methods
    testSuite.test('Connect4', 'Helper methods', () => {
        const game = new Connect4Game();
