/**
 * Unit Tests for Connect4UI Class
...
describe('Connect4UI Unit Tests', () => {
    let mockGame;
    let connect4UI;
    let dom;
    let document;
    ...
    beforeEach(() => {
        ...
        // Import and create Connect4UI after mocking
        const { Connect4UI } = await import('../../../games/connect4/js/ui.js');
        connect4UI = new Connect4UI(mockGame);
