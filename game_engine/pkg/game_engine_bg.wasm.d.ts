...
export const game_detect_bottom_row_forks: (a: number, b: number) => [number, number];
export const game_get_fork_blocking_moves: (a: number) => [number, number];
export const game_has_critical_fork_threats: (a: number) => number;
export const game_detect_open_three: (a: number, b: number) => [number, number];
export const game_detect_closed_four: (a: number, b: number) => [number, number];
export const game_detect_double_three_forks: (a: number, b: number) => [number, number];
export const game_get_threat_level: (a: number, b: number, c: number, d: number) => number;
export const game_get_dangerous_moves_gobang: (a: number) => [number, number];
export const game_get_winning_moves_gobang: (a: number) => [number, number];
export const game_get_blocking_moves_gobang: (a: number) => [number, number];
