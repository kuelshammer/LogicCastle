...
export const triogame_get_board: (a: number, b: number) => void;
...
export const triogame_new_with_distribution_wasm: (a: number) => number;
export const triogame_analyze_reachable_targets_wasm: (a: number) => number;
export const triogame_count_solutions_for_target_wasm: (a: number, b: number) => number;
export const triogame_categorize_target_difficulty_wasm: (a: number, b: number) => number;
export const triogame_comprehensive_gap_analysis: (a: number) => void;
export const __wbg_lgamemove_free: (a: number, b: number) => void;
export const __wbg_get_lgamemove_l_piece_anchor_row: (a: number) => number;
export const __wbg_set_lgamemove_l_piece_anchor_row: (a: number, b: number) => void;
export const __wbg_get_lgamemove_l_piece_anchor_col: (a: number) => number;
export const __wbg_set_lgamemove_l_piece_anchor_col: (a: number, b: number) => void;
export const __wbg_get_lgamemove_l_piece_orientation: (a: number) => number;
export const __wbg_set_lgamemove_l_piece_orientation: (a: number, b: number) => void;
export const __wbg_get_lgamemove_neutral_piece_id: (a: number) => number;
export const __wbg_set_lgamemove_neutral_piece_id: (a: number, b: number) => void;
export const __wbg_get_lgamemove_neutral_new_row: (a: number) => number;
export const __wbg_set_lgamemove_neutral_new_row: (a: number, b: number) => void;
export const __wbg_get_lgamemove_neutral_new_col: (a: number) => number;
export const __wbg_set_lgamemove_neutral_new_col: (a: number, b: number) => void;
export const __wbg_lgame_free: (a: number, b: number) => void;
export const lgame_new: () => number;
export const lgame_getBoard: (a: number) => number;
export const lgame_getCurrentPlayer: (a: number) => number;
export const lgame_isGameOver: (a: number) => number;
export const lgame_getWinner: (a: number) => number;
export const lgame_getLegalMoves: (a: number) => number;
export const lgame_makeMove: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => void;
export const __wbg_hexboard_free: (a: number, b: number) => void;
export const hexboard_new: () => number;
export const hexboard_get_cell: (a: number, b: number, c: number) => number;
export const hexboard_set_cell: (a: number, b: number, c: number, d: number, e: number) => void;
export const hexboard_clear: (a: number) => void;
export const hexboard_memory_usage: (a: number) => number;
export const hexboard_dimensions: (a: number, b: number) => void;
export const hexboard_is_valid_position: (a: number, b: number, c: number) => number;
export const hexboard_count_stones: (a: number, b: number) => number;
export const hexboard_get_board_debug: (a: number, b: number) => void;
export const __wbg_gomokuboard_free: (a: number, b: number) => void;
export const gomokuboard_new: () => number;
export const gomokuboard_get_cell: (a: number, b: number, c: number) => number;
export const gomokuboard_make_move: (a: number, b: number, c: number, d: number) => void;
export const gomokuboard_check_win: (a: number) => number;
export const gomokuboard_is_game_over: (a: number) => number;
export const gomokuboard_get_winner: (a: number) => number;
export const gomokuboard_get_current_player: (a: number) => number;
export const gomokuboard_get_move_count: (a: number) => number;
export const gomokuboard_clear: (a: number) => void;
export const gomokuboard_get_board: (a: number, b: number) => void;
export const gomokuboard_memory_usage: (a: number) => number;
export const gomokuboard_is_valid_position: (a: number, b: number, c: number) => number;
export const gomokuboard_count_stones: (a: number, b: number) => number;
export const gomokuboard_get_legal_moves: (a: number, b: number) => void;
export const trioboardbitpacked_new: (a: number) => number;
export const trioboardbitpacked_get_cell: (a: number, b: number, c: number) => number;
export const trioboardbitpacked_get_target_number: (a: number) => number;
export const trioboardbitpacked_get_difficulty: (a: number) => number;
export const trioboardbitpacked_get_board: (a: number, b: number) => void;
export const trioboardbitpacked_is_valid_position: (a: number, b: number, c: number) => number;
export const trioboardbitpacked_check_combination: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => number;
export const trioboardbitpacked_regenerate: (a: number, b: number) => void;
export const trioboardbitpacked_get_performance_stats: (a: number, b: number) => void;
export const game_is_terminal: (a: number) => number;
export const __wbg_trioboardbitpacked_free: (a: number, b: number) => void;
export const trioboardbitpacked_memory_usage: (a: number) => number;
