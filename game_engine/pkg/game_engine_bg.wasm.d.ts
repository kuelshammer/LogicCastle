...
export const lgame_new_with_starting_player: (a: number) => number;
...
export const lgame_memory_usage: (a: number) => number;
export const lgame_get_current_player: (a: number) => number;
export const lgame_get_move_count: (a: number) => number;
export const lgame_get_winner: (a: number) => number;
export const lgame_is_game_over: (a: number) => number;
export const lgame_get_board: (a: number, b: number) => void;
export const lgame_can_undo: (a: number) => number;
export const lgame_undo_move: (a: number) => number;
export const lgame_analyze_position: (a: number) => number;
export const lgame_get_game_phase: (a: number) => number;
export const lgame_reset_with_starting_player: (a: number, b: number) => void;
export const lgame_newGame: (a: number) => void;
export const lgame_undoMove: (a: number) => number;
export const lgame_get_valid_l_moves_json: (a: number, b: number) => void;
export const lgame_is_valid_l_move: (a: number, b: number, c: number, d: number) => number;
export const lgame_get_neutral_positions: (a: number, b: number) => void;
export const lgame_get_l_piece_position: (a: number, b: number, c: number) => void;
