...
class HintManager {
    ...
    generateHints(analysis) {
        ...
        if (this.helpLevel >= 1) {
            this.generateCriticalHints(analysis);
        }
        
        // Level 2: Add warnings about dangerous moves
        if (this.helpLevel >= 2) {
            this.generateWarningHints(analysis);
        }
        
        // Level 3: Add strategic suggestions
        if (this.helpLevel >= 3) {
            this.generateStrategicHints(analysis);
        }
        
        // Level 4: Full analysis with detailed explanations
        if (this.helpLevel >= 4) {
            this.generateDetailedHints(analysis);
        }
    }
     ...
     * @private
     */
    generateCriticalHints(analysis) {
     ...
     * @private
     */
    generateDetailedHints(analysis) {
