  ...
  getAIMove() {
    ...
    if (!this.ai) {
      ...
      case 'vs-bot-easy':
        ...
        break;
      case 'vs-bot-medium':
        difficulty = 'defensiv-gemischt'; // Bot (Mittel) - 45% Winrate - Solidere Mittelstufe
        break;
      case 'vs-bot-strong':
        difficulty = 'defensive'; // Bot (Stark) - 60% Winrate - Reine Muster-Disruption
        break;
      case 'vs-bot-expert':
        difficulty = 'monte-carlo'; // Bot (Expert) - 90%+ Winrate - Simulation-basierte KI
        break;
