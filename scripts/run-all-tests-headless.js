...
async function runComprehensiveTests() {
  ...
  try {
    ...
    const testResults = await page.evaluate(() => {
      /* global TestSuite, runBackendGameCoreTests, runBackendGameEdgeCasesTests, runBackendEventsTests, runBackendSimulationTests, runAIStrategyEnhancedSmartTests, runAIStrategyConsistencyTests, runAIStrategySmartRandomTests, runHelperSystemLevelsTests, runHelperSystemStrategicTests, runHelperSystemHintsTests, runHelperSystemEventsTests, runHelperSystemPerformanceTests, runHelperSystemRegressionTests, runUIComponentBoardTests, runUIComponentControlsTests, runUIComponentInteractionsTests, runUIComponentVisualTests, runIntegrationGameFlowTests, runIntegrationAIUITests, runIntegrationHelpersUITests, runIntegrationCrossComponentTests, runRegressionAnimationChaosTests, runRegressionStateCorruptionTests, runConnect4Tests, runTrioTests, runGobangTests */
...
export { runComprehensiveTests, startServer, generateJUnitXML };
